...
def run_test_generate_points_on_circle():
    ...
    # Test 2:
    expected = [rg.Point(250.0, 75),  # All numbers are approximate.
                rg.Point(150.0, 75)]
...
def run_test_draw_points_on_circle():
    ...
    # Test 4:
    title = 'DRAW_POINTS_ON_CIRCLE, test 4:  4 green dots.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(100, 150), 50)
    draw_points_on_circle(window, circle, 4, 'green')
    window.close_on_mouse_click()
...
def run_test_pizza():
    ...
    # Test 4:
    title = 'PIZZA test 1:  12 slices, 7 thickness purple lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 100), 100)
    circle.outline_thickness = 7
    pizza(window, circle, 12, 'purple', 7)
    window.close_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON test 4:  40 red lines on white circle, hops = 10.'
    window = rg.RoseWindow(600, 400, title)

    circle = rg.Circle(rg.Point(400, 150), 200)
    circle.fill_color = 'white'
    fancy_polygon(window, circle, 40, 10, 'red', 5)
    window.close_on_mouse_click()
